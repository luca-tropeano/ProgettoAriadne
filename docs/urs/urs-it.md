...
| NFR6 | Il sistema deve supportare l'integrazione con sistemi esterni, inclusi moduli AI per parsing MDF (API DeepSeek implementata come fallback a pagamento per estrazione BOM, disabilitata di default; parsing MDF avanzato per fasi successive) | D        |
