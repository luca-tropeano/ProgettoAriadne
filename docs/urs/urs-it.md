...
| ---- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- |
| FR1  | Il sistema deve importare file BOM, inizialmente in formato Excel (tramite EPPlus) per la fase di prova e verifica, per ottenere un elenco di componenti C1. Dopo la fase iniziale, l'import diretto da altre fonti potrà sostituire il passaggio Excel — Excel non è mai usato come storage persistente                                     | M        |
...
| NFR2 | Il sistema deve permettere aggiornamenti di dispositivi, BOM e materiali tramite importazione Excel (EPPlus)        | M        |
